...
;
; SweetHome3D-4.1.1-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 4.1.1
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=..\SweetHome3D-4.1.1-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
VersionInfoVersion=4.1.1.0
VersionInfoTextVersion=4.1.1

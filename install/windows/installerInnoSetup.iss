...
;
; SweetHome3D-2.4-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 2.4
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=..\SweetHome3D-2.4-windows
Compression=lzma
SolidCompression=yes
ChangesAssociations=yes
VersionInfoVersion=2.4.0.0
VersionInfoTextVersion=2.4

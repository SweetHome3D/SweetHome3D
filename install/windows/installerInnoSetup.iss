...
;
; SweetHome3D-2.3-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 2.3
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=..\SweetHome3D-2.3-windows
Compression=lzma
SolidCompression=yes
ChangesAssociations=yes
VersionInfoVersion=2.3.0.0
VersionInfoTextVersion=2.3

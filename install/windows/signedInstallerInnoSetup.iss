...
;
; SweetHome3D-5.5.2-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 5.5.2
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=SweetHome3D-5.5.2-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
VersionInfoVersion=5.5.2.0
VersionInfoTextVersion=5.5.2

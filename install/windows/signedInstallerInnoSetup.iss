...
;
; SweetHome3D-5.4-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 5.4
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=..\SweetHome3D-5.4-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
VersionInfoVersion=5.4.0.0
VersionInfoTextVersion=5.4

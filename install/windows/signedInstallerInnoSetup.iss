...
;
; SweetHome3D-4.6.1-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 4.6.1
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=..\SweetHome3D-4.6.1-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
VersionInfoVersion=4.6.1.0
VersionInfoTextVersion=4.6.1
...
Type: files; Name: "{app}\jre6\lib\rt.jar"

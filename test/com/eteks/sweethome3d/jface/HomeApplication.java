/*
 * HomeApplication.java 10 aout 2006
 *
 ...
 */
public class HomeApplication extends ApplicationWindow implements HomeView {
  private Home home;
  private UserPreferences preferences;

  private Map<ActionType, ResourceAction> actions;

  public HomeApplication(Home home, UserPreferences preferences, HomeController controller) {
    super(null);
    this.home = home;
